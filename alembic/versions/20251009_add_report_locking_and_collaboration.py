...
def upgrade() -> None:
    ...
    op.create_table('report_locks',
    sa.Column('id', sa.String(length=36), nullable=False),
    sa.Column('report_id', sa.String(length=36), nullable=False),
    sa.Column('locked_by', sa.String(length=36), nullable=False),
    sa.Column('locked_at', sa.DateTime(), server_default=sa.text('(datetime(\'now\'))'), nullable=True),
    ...
    sa.Column('comment_type', sa.String(length=50), server_default='general', nullable=True),
