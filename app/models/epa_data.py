...
class EmissionFactor(BaseModel, AuditMixin):
    ...
    category = Column(String(100), nullable=False, index=True)  # fuel, electricity, etc.
...
class EPADataUpdate(BaseModel, AuditMixin):
    ...
    update_date = Column(DateTime(timezone=True), server_default=func.now(), nullable=False)
