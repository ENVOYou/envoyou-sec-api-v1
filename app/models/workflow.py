...
class WorkflowTemplate(BaseModel, AuditMixin):
    ...
    workflow_type = Column(String(100), nullable=False)  # "report_approval", "consolidation_approval"
...
class Workflow(BaseModel, AuditMixin):
    ...
    subject_type = Column(String(100), nullable=False)  # "consolidated_emissions", "report"
...
class ApprovalRequest(BaseModel, AuditMixin):
    ...
    # Request status
    status = Column(String(50), default="pending", nullable=False)  # pending, approved, rejected, delegated
...
class NotificationQueue(BaseModel, AuditMixin):
    ...
    notification_type = Column(String(100), nullable=False)  # approval_request, status_change, reminder
    ...
    # Delivery details
    delivery_method = Column(String(50), default="email", nullable=False)  # email, in_app, sms
