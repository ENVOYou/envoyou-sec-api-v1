...
from app.models.epa_data import FuelType, ElectricityRegion, EmissionFactorSource
...
class ElectricityEmissionFactorRequest(BaseModel):
    ...
    def validate_region(cls, v):
        ...
        if v.lower() not in valid_regions:
            raise ValueError(f'Invalid electricity region. Must be one of: {valid_regions}')
        return v.lower()
