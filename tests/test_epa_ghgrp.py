...
async def test_epa_ghgrp_service():
    ...
    try:
        ...
        for i, (code, name) in enumerate(list(ghgrp_service.industry_sectors.items())[:5]):
        ...
        for scenario in ghgrp_emissions_scenarios:
            comparison = ghgrp_service._compare_emissions(
                our_emissions=our_emissions,
                ghgrp_emissions=scenario["data"]
            )
            
            print(f"  {scenario['scenario']}:")
            print(f"    Validation Score: {comparison['validation_score']:.1f}%")
            print(f"    Difference: {comparison['summary']['difference_percentage']:.1f}%")
        ...
        for scenario in current_scenarios:
            ...
            for anomaly in anomalies:
                print(f"    - {anomaly['type']}: {anomaly['change_percentage']:.1f}% change ({anomaly['severity']})")
        ...
        for scenario in ghgrp_factors_scenarios:
            validation = ghgrp_service._validate_emission_factor(
                ...
                ghgrp_factors=scenario["factors"]
            )
        ...
        mock_industry_data = {
            "emissions": [
                {"total_emissions": 1000.0, "scope1_emissions": 600.0, "scope2_emissions": 400.0},
                {"total_emissions": 1500.0, "scope1_emissions": 900.0, "scope2_emissions": 600.0},
                {"total_emissions": 2000.0, "scope1_emissions": 1200.0, "scope2_emissions": 800.0},
                {"total_emissions": 2500.0, "scope1_emissions": 1500.0, "scope2_emissions": 1000.0},
                {"total_emissions": 3000.0, "scope1_emissions": 1800.0, "scope2_emissions": 1200.0},
                {"total_emissions": 3500.0, "scope1_emissions": 2100.0, "scope2_emissions": 1400.0},
                {"total_emissions": 4000.0, "scope1_emissions": 2400.0, "scope2_emissions": 1600.0},
                {"total_emissions": 4500.0, "scope1_emissions": 2700.0, "scope2_emissions": 1800.0},
                {"total_emissions": 5000.0, "scope1_emissions": 3000.0, "scope2_emissions": 2000.0},
                {"total_emissions": 5500.0, "scope1_emissions": 3300.0, "scope2_emissions": 2200.0}
            ]
        }
        ...
        print("The EPA GHGRP data integration service has been successfully implemented with:")
