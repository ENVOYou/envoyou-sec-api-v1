...
def test_calculation_schemas():
    ...
    try:
        from app.schemas.emissions import Scope1CalculationRequest, ActivityDataInput
...
def test_api_structure():
    ...
    try:
        from app.api.v1.endpoints import emissions, auth
...
def test_calculation_logic():
    ...
    try:
        ...
        print(f'✅ Natural gas calculation: {quantity} MMBtu × {natural_gas_factor} = {emissions:.2f} tCO2e')
